...
class TrainingGUI(tk.Tk):
    def __init__(self):
        ...
        self._run_btn = tk.Button(self, text="Run Training", font=('TkDefaultFont', 11, 'bold'),
    ...
    def _build_inputs_tab(self):
        ...
        self._bg_panel = FileListPanel(tab, "Background Masks (one per image, RGBA PNG)", add_label="+ Add BG Mask")
